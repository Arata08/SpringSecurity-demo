...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, 'test', NULL, NULL, '0', '0', 'sayhello1', '#', NULL, NULL, NULL, NULL, 0, NULL);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, 'test', '1', '0', 0, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `sys_user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1854448800877535236 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'chen', 'NULL', '$2a$10$9TRFJfJ53osGX7rxNeM5XeQLdTO21mIZpQZHNCT/T6PvwviZZsZ0i', '0', NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, NULL, 0);
